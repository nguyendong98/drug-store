...
const product_category_schema_1 = require("./product-category.schema");
    ...
    common_1.Module({
        imports: [
            ...
            mongoose_1.MongooseModule.forFeature([
                ...
                { name: 'product-category-groups', schema: product_category_group_schema_1.ProductCategoryGroupSchema },
            ]),
        ],
