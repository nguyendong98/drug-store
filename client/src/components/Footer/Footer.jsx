...
export const Footer = () => (
        <Grid container className="footer px-3 py-8" >
            <Grid item xs={12} sm={6} md={4} lg={3}>
                ...
                <Typography variant="subtitle1" gutterBottom><a href="google.com">Partner with PharmEasy</a></Typography>
            ...
            <Grid container direction="column" className="mt-3">
                ...
                <Grid container direction="row" justify="space-between" alignItems="center">
                    <Grid item xs={12} md={7}>
                        <img src="https://d2y2l77dht9e8d.cloudfront.net/web-assets/dist/af0c6812.svg" alt="google pay" className="our-payment"/>
                        <img src="https://d2y2l77dht9e8d.cloudfront.net/web-assets/dist/0e010044.svg" alt="pay tm" className="our-payment"/>
                        <img src="https://d2y2l77dht9e8d.cloudfront.net/web-assets/dist/1066bb1f.svg" alt="Amazon Pay" className="our-payment"/>
                        <img src="https://d2y2l77dht9e8d.cloudfront.net/web-assets/dist/3a1a533d.svg" alt="google pay" className="our-payment"/>
                        <img src="https://d2y2l77dht9e8d.cloudfront.net/web-assets/dist/fbea1701.svg" alt="Mobikwik" className="our-payment"/>
                        <img src="https://d2y2l77dht9e8d.cloudfront.net/web-assets/dist/4733a49d.svg" alt="Airtel Money" className="our-payment"/>
                        <img src="https://d2y2l77dht9e8d.cloudfront.net/web-assets/dist/b278e536.svg" alt="Ola Money" className="our-payment"/>
                        <img src="https://d2y2l77dht9e8d.cloudfront.net/web-assets/dist/0aca2077.svg" alt="Maestro" className="our-payment"/>
                        <img src="https://d2y2l77dht9e8d.cloudfront.net/web-assets/dist/44a51ca5.svg" alt="Mastercard" className="our-payment"/>
                        <img src="https://d2y2l77dht9e8d.cloudfront.net/web-assets/dist/d058b00d.svg" alt="Visa" className="our-payment"/>
                        <img src="https://d2y2l77dht9e8d.cloudfront.net/web-assets/dist/e9445364.svg" alt="Rupay" className="our-payment"/>
                        <img src="https://d2y2l77dht9e8d.cloudfront.net/web-assets/dist/6e09c713.svg" alt="Diners" className="our-payment"/>
                    </Grid>
                    <Grid item className="mt-sm-3 mt-md-1"><Typography variant="subtitle1">© 2020 DV Pharmacy. All Rights Reserved</Typography></Grid>
                </Grid>
            </Grid>
        </Grid>
