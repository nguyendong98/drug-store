...
export const CustomerManageTable = ({data}) => {
    ...
    return (
        <>
            ...
            <CustomerForm open={openDialogForm} closeDialogForm={onCloseDialogForm} />
            <MaterialTable
                ...
                columns={[
                    ...
                    },
                    {
                        ...
                        render: rowData => <MenuItem>
                            ...
                            <Typography variant="body2" style={{color: '#808080'}}>Preview</Typography>
                        </MenuItem>
                    }
